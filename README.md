...
| ChatGPT 文件直链下载按钮助手 | [`chatgpt-direct-download.user.js`](https://raw.githubusercontent.com/Ember-Dawn/userscript-cyan-release/main/userscripts/chatgpt/chatgpt-direct-download.user.js) | 为生成文件增加直接下载按钮。 |
