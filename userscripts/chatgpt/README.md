...
ChatGPT GitHub 自动允许助手已停止使用和维护，最终版本归档为：
...
```text
archive/userscripts/chatgpt-read-aloud-enhancer-v4.0.8.user.js
archive/userscripts/chatgpt-read-aloud-enhancer-v4.0.8.md
```
